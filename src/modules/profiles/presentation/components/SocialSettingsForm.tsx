...
import { Loader2, Globe, Eye, EyeOff, Users2 } from "lucide-react";
...
export function SocialSettingsForm({ initialSocialActive = false, initialSearchable = true }: SocialSettingsFormProps) {
