    ...
    return (
        <div className="rounded-2xl border bg-card p-6 shadow-sm space-y-6">
            ...
            <div className="flex flex-col items-center justify-center space-y-6">
                {/* Circular Visualizer (simplified with progress bar for now) */}
                ...
                <div className="flex items-center gap-4 w-full">
                    <button
                        onClick={resetTimer}
                        className="flex-1 h-12 flex items-center justify-center rounded-xl bg-accent/20 text-muted-foreground hover:text-foreground transition-colors"
                    >
                    ...
                    <div className="flex-1 h-12 flex items-center justify-center rounded-xl bg-accent/20 text-muted-foreground">
